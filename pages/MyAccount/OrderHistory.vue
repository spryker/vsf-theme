      ...
      <div v-if="currentOrder">
        ...
        <div class="highlighted highlighted--total">
          ...
          <SfProperty
            name="Total"
            :value="
              orderGetters.getFormattedPrice(
              ...
              ><SfLink
                :link="
                  '/p/' +
                    ...
                    orderGetters.getItemSku(item)
                "
                >{{ orderGetters.getItemName(item) }}</SfLink
              ></SfTableData
            >
            <SfTableData>{{
              orderGetters.getFormattedPrice(orderGetters.getItemPrice(item))
            }}</SfTableData>
      ...
      <div v-else>
        ...
        <SfTable v-else class="orders">
          ...
          <SfTableRow v-for="order in orders" :key="orderGetters.getId(order)">
            ...
            <SfTableData>{{
              orderGetters.getFormattedPrice(orderGetters.getPrice(order))
            }}</SfTableData>
            <SfTableData>
